...
import urllib3
from deutschland.berufssprachkurssuche.exceptions import ApiValueError
...
class Configuration(object):
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = (
            "https://rest.arbeitsagentur.de/infosysbub/sprachfoerderung"
            if host is None
            else host
        )
        """Default Base url
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("berufssprachkurssuche")
