...
class ResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten - a model defined in OpenAPI
