...
class ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten(
    ModelNormal
):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten - a model defined in OpenAPI
