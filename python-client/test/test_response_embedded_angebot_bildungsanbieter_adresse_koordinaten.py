...
class TestResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten(unittest.TestCase):
    """ResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten(self):
        """Test ResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedAngebotBildungsanbieterAdresseKoordinaten()  # noqa: E501
        pass
