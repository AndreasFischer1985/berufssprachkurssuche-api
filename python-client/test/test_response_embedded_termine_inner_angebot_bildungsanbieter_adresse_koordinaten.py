...
class TestResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten(
    unittest.TestCase
):
    """ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten(self):
        """Test ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresseKoordinaten()  # noqa: E501
        pass
